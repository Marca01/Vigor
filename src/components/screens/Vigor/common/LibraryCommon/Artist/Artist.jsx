...
export default function Artist({navigation}) {
	...
	const ARTISTS = [
		...
		{
			id: '1', 
			url: 'https://i.pinimg.com/564x/68/fa/e9/68fae9281f9f74e113b3224a50b13aac.jpg',
			artist: 'Ava Max',
			songs: 10,
			listeners: '10M',
			followers: '10.5k'
		...
		{
			id: '2', 
			url: 'https://i.pinimg.com/564x/ac/64/61/ac6461fbc00057141005b768aedf7a3b.jpg',
			artist: 'Alan Walker',
			songs: 15,
			listeners: '9M',
			followers: '1.5k'
		...
		{
			id: '3', 
			url: 'https://i.pinimg.com/564x/42/74/78/427478916a5f8a0923653bb131342633.jpg',

...
import { View, Text, TouchableWithoutFeedback, Keyboard, FlatList, TouchableOpacity, Image, TextInput } from 'react-native'
...
export default function Album({navigation}) {
	...
	const ALBUMS = [
		...
		{
			id: '1', 
			url: 'https://i.pinimg.com/564x/c9/4f/ea/c94fea83c106aae300adba72a4941051.jpg',
		...
		{
			id: '2', 
			url: 'https://i.pinimg.com/564x/57/88/00/5788002984cabcfff17007b467421140.jpg',
		...
		{
			id: '3', 
			url: 'https://i.pinimg.com/564x/e1/a3/de/e1a3de3ac657755084807f547c12064e.jpg',
								...
								item.id === '0' ? (
									...
									<View style={globalStyles.albums__album}>
										<AlbumList 
											...
											onPress={() => navigation.navigate('AlbumDetail', {item: item})}
										/>
									</View>
								)
							)}

...
export default function DemoCode() {
    ...
    const DrawerNav = () => {
        return ( <
            ...
            // }}
            drawerContent = {
                (navigation) => < DrawerContent {...navigation }
                />} >
                <
                Drawer.Screen
                name = 'Home'
        ...
        const StackNavigator = ({ navigation }) => {
            ...
            return ( <
                ...
                options = {
                    ({ route }) => ({ headerBackTitle: route.params ? .manufacturer, title: '', headerBackTitleStyle: { fontWeight: '900' }, headerTitleAlign: 'center' }) }
                component = { About }
                /> <
                /Stack.Navigator>
            )
        ...
        const moreStackNavigator = ({ navigation, route }) => {
            return ( <
                ...
                /> <
                Stack.Screen name = 'CalendarAsync'
